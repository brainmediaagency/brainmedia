...
describe('permissions', () => {
  it('maps roles to routes', () => {
    ...
    expect(canAccessRoute('sef', 'sef')).toBe(true)
    expect(canAccessRoute('sef', 'news-sites')).toBe(true)
    expect(canAccessRoute('sef', 'game')).toBe(true)
    expect(canAccessRoute('sef', 'management')).toBe(false)
    expect(canAccessRoute('sef', 'coordinator')).toBe(false)
    expect(getDefaultRouteForRole('reporter')).toBe('/reporter')
    expect(getDefaultRouteForRole('kameraman')).toBe('/reporter')
    expect(getDefaultRouteForRole('sef')).toBe('/sef')
  })
})
